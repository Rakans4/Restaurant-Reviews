# Resturant Review
This an application that displays a list of resturants with related information, opening hours, location and reviews.

## How to run the app?
1. Run `git clone https://github.com/Rakans4/Restaurant-Reviews.git` in your terminal.
